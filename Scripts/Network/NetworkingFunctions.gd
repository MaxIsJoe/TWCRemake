			...
			0:
				match house:
					0:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewGrifMale)
						NewGrifMale.PlayerName = charname
						NewGrifMale.updatenamelabel()
						#Teleport.Move_To_Scene(loc, NewGrifMale, locSpawnPos)
						Teleport.TeleportPos(NewGrifMale, locSpawnPos, null)
					1:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewHuffMale)
						NewHuffMale.PlayerName = charname
						NewHuffMale.updatenamelabel()
						Teleport.TeleportPos(NewHuffMale, locSpawnPos, null)
					2:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewClawfMale)
						NewClawfMale.PlayerName = charname
						NewClawfMale.updatenamelabel()
						Teleport.TeleportPos(NewClawfMale, locSpawnPos, null)
					3:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewSlythMale)
						NewSlythMale.PlayerName = charname
						NewSlythMale.updatenamelabel()
						Teleport.TeleportPos(NewSlythMale, locSpawnPos, null)
			1:
				match house:
					0:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewGrifFemale)
						NewGrifFemale.PlayerName = charname
						NewGrifFemale.updatenamelabel()
						Teleport.TeleportPos(NewGrifFemale, locSpawnPos, null)
					1:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewHuffFemale)
						NewHuffFemale.PlayerName = charname
						NewHuffFemale.updatenamelabel()
						Teleport.TeleportPos(NewHuffFemale, locSpawnPos, null)
					2:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewClawFemale)
						NewClawFemale.PlayerName = charname
						NewClawFemale.updatenamelabel()
						Teleport.TeleportPos(NewClawFemale, locSpawnPos, null)
					3:
						...
						NetworkManager.Network.PlayerContainer.add_child(NewSlythFemale)
						NewSlythFemale.PlayerName = charname
						NewSlythFemale.updatenamelabel()
						Teleport.TeleportPos(NewSlythFemale, locSpawnPos, null)
