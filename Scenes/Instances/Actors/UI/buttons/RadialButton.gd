...
func _on_RadialButton_button_down():
	#Handles what happens when clicking on a button, not really the most ideal way of doing this but I have no better ideas so this is the way we're going to do stuff for now.
