...
@export var MiniumPasswordLength = 3 # (int, 3, 32)
...
###(Max): Note to self or anyone working checked this, rename Button and Button2 and Button3 to something else
...
func _on_Button3_button_down():
	randomize()
	var randomkey = int(randf_range(-100000,100000)) #(Max): Too simple for my liking, I'll remember to add a task in my to-do list to create a complex random key generator that's complicated for no reason.
